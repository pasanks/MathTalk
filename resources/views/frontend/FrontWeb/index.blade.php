...
{{--                <div class="single_special_cource">--}}
{{--                    <img src="{{ asset('FrontWeb/img/special_cource_2.png') }}" class="special_img" alt="">--}}
{{--                    <div class="special_cource_text">--}}
{{--                        <a href="{{route('frontend.courseDetails')}}" class="btn_4">design</a>--}}
{{--                        <h4>$160.00</h4>--}}
{{--                        <a href="{{route('frontend.courseDetails')}}"> <h3>Web UX/UI Design </h3></a>--}}
{{--                        <p>Which whose darkness saying were life unto fish wherein all fish of together called</p>--}}
{{--                        <div class="author_info">--}}
{{--                            <div class="author_img">--}}
{{--                                <img src="{{ asset('FrontWeb/img/author/author_2.png') }}" alt="">--}}
{{--                                <div class="author_info_text">--}}
{{--                                    <p>Conduct by:</p>--}}
...
{{--            <div class="col-sm-6 col-lg-4">--}}
{{--                <div class="single_special_cource">--}}
{{--                    <img src="{{ asset('FrontWeb/img/special_cource_3.png') }}" class="special_img" alt="">--}}
{{--                    <div class="special_cource_text">--}}
...
{{--                        <div class="author_info">--}}
{{--                            <div class="author_img">--}}
{{--                                <img src="{{ asset('FrontWeb/img/author/author_3.png') }}" alt="">--}}
{{--                                <div class="author_info_text">--}}
{{--                                    <p>Conduct by:</p>--}}
{{--                                    <h5><a href="#">James Well</a></h5>--}}
{{--                                </div>--}}
