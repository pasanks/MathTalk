<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{
                    active_class(Route::is(' admin/lms/grade'))
            ...
            <li class="nav-item">
                <a class="nav-link {{
                    active_class(Route::is(' admin/lms/class'))
            ...
            <li class="nav-item">
                <a class="nav-link {{
                    active_class(Route::is(' admin/lms/class_session'))
                }}" href="{{ route('admin.class_session.index') }}">
                    <i class="nav-icon fas fa-tachometer-alt"></i>
                    @lang('Class Sessions')
                </a>
            </li>
